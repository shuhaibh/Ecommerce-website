                  ...
                  {products.map(product => (
                    <tr key={product._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-4">
                        <button onClick={() => handleAction(approveProduct, product._id, 'Product Approved!')} className="text-green-600 hover:text-green-900 font-semibold">Approve</button>
                        <button onClick={() => handleAction(rejectProduct, product._id, 'Product Rejected!')} className="text-red-600 hover:text-red-900 font-semibold">Reject</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
